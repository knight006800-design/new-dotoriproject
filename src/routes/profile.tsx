  ...
  return (
    <div className="min-h-screen bg-background pb-20">
      ...
      <main className="mx-auto max-w-md px-5 pt-5">
        ...
        <Link
          to="/admin"
          className="mt-2 flex items-center justify-between rounded-2xl border border-border bg-card px-4 py-3.5"
        >
          <div className="flex items-center gap-2.5">
            <span className="grid size-9 place-items-center rounded-full bg-accent text-accent-foreground">
              <svg viewBox="0 0 24 24" className="size-4.5 fill-none stroke-current stroke-2 stroke-round"><path d="M3 17l4-8 4 4 4-6 4 10"/></svg>
            </span>
            <div>
              <p className="text-[13.5px] font-semibold">관리자 · ESG 대시보드</p>
              <p className="text-[11.5px] text-muted-foreground">탄소절감 실적 · 운송 현황</p>
            </div>
          </div>
          <span className="text-muted-foreground">›</span>
        </Link>
